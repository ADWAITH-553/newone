...
// cehck wether the user is logged in or not
  ...
  const logout = () => {
    ...
    localStorage.removeItem("bookcater")
    localStorage.removeItem("description")
    localStorage.removeItem("catername")
        ...
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="text-black hover:text-red-500 block px-3 py-2 rounded-md text-base font-medium">
              ...
              {/* {checkLogin()&&<div className="text-black hover:text-red-500 block px-13 py-2 rounded-md text-base font-medium">
              <Link to={`/User/${localStorage.getItem("Uname")}`}>Feedback</Link>
              </div>} */}
              {!checkLogin()&&<div className="text-black hover:text-red-500 block px-3 py-2 rounded-md text-base font-medium">
              <Link to="/login">Login</Link>
              </div>}
